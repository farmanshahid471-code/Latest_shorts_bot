...
clip's transcript and speaks it with a Chinese TTS voice, timed line-by-line to
the original subtitles, mixed over a ducked version of the source audio. Eight
voices are available (Mandarin, Taiwanese, Cantonese). It is Bilibili-only —
YouTube and TikTok keep the original audio — and best-effort, so a TTS failure
still posts the clip undubbed. See `SETUP_BILIBILI.md`.
